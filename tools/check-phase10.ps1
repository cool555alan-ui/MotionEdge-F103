...
try {
  $required=@('Services/config_store.c','Services/config_store.h','Services/config_persistence.c','BSP/bsp_flash.c','BSP/config_flash_reserve.S','tools/check-firmware-size.py','.github/workflows/ci.yml','.github/workflows/release.yml','VERSION','CHANGELOG.md','RELEASE_NOTES_v1.0.0.md')
